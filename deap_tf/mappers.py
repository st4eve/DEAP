...
from deap_tf.helpers import bisect_min, getOutputShape
from deap_tf.photonics import MRRTransferFunction
from deap_tf.photonics import MRMTransferFunction
from deap_tf.photonics import PWB
from deap_tf.photonics import LaserDiodeArray
from deap_tf.photonics import ModulatorArray
from deap_tf.photonics import PWBArray
from deap_tf.photonics import PhotonicConvolver
...
class PWBMapper:
    ...
    def computePhaseShifts(weights):
        ...
        weights = weights
        maxElement = tf.math.reduce_max(tf.abs(weights))

        # Normalize the weights and compute the post-optical gain.
        outputGain = tf.math.maximum(maxElement, 1)
        ...
        phaseShifts = np.zeros(weights.shape[0])
        ...
        return tf.convert_to_tensor(phaseShifts, dtype=tf.float32), outputGain
